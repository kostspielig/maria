defmodule Maria.RecipesTest do
  ...
  describe "recipes" do
    ...
    test "create_recipe/1 with valid data creates a recipe" do
      valid_attrs = %{descrition: "some descrition", directions: "some directions", ingredients: ["option1", "option2"], likes: 42, mins: 42, tags: ["option1", "option2"], title: "some title"}

      assert {:ok, %Recipe{} = recipe} = Recipes.create_recipe(valid_attrs)
      assert recipe.descrition == "some descrition"
    ...
    test "update_recipe/2 with valid data updates the recipe" do
      ...
      assert recipe.descrition == "some updated descrition"
